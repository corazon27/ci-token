    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-2 mb-4 mb-md-0">
                ...
                <a href="<?= base_url('user/profile/setting'); ?>" class="btn btn-sm btn-block btn-primary"><i
                        class="fa fa-edit"></i> Edit Profile</a>
                <a href="<?= base_url('user/profile/ubahpassword'); ?>" class="btn btn-sm btn-block btn-primary"><i
